...
/** Card form of a saved bookmark page — mirrors ResourceCard layout. */
export function BookmarkCard({ bookmark, resource, onRemove }: BookmarkCardProps) {
      ...
      <div className="relative z-10 mt-4 flex items-center justify-between gap-2 border-t border-border pt-3 text-xs font-medium text-muted-foreground">
        <span className="inline-flex min-w-0 items-center gap-1.5">
          ...
          <span className="truncate">
            Page {bookmark.page} · {formatDate(bookmark.createdAt)}
          </span>
        </span>
        <Link
