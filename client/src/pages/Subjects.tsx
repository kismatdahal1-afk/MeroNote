...
import { getAllSemesters, getSubjectsBySemester, getAllResources, countResourcesBySubject, getAllSubjects } from "../data/selectors";
...
export default function Subjects() {
  ...
  return (
    <div>
      ...
      <div className="mb-6 grid grid-cols-2 gap-3 sm:flex sm:flex-nowrap">
        <Select
