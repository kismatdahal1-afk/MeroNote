...
const resourceSeeds: ResourceSeed[] = [
  ...
  // Project
  { id: "res-project-guide", title: "Final Project â€” Report Template & Guide", description: "Report structure, formatting rules, and evaluation criteria guide.", subjectId: "sub-project", type: "custom", fileSizeMB: 0.8, pageCount: 24, tags: ["template", "report"], uploadedDaysAgo: 6 },
